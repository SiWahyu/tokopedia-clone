export default function LoginCard() {
  return (
    <div className="flex justify-between gap-4 px-5.5 pt-2" id="header2">
      <div className=" flex gap-2 items-start w-fit overflow-hidden">
        <img
        ...
        <div className="flex flex-col">
          ...
          <small className="font-extralight truncate">
            Akses semua fitur, yuk~
          </small>
        </div>
      </div>
      <div className="masuk place-self-center">
        <button className="bg-[#00aa5b] px-[27px] text-white py-[5px] rounded-lg text-[15px] font-bold truncate">
          Masuk
        </button>
      </div>
    </div>
